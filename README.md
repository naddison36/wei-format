...
- Click the Chrome plug-in icon
- the Hex converter converts the hexadecimal number to decimal then converters wei to eth like above

- For example,
- 11200C7644D50000 converts to 123423400000000000000000 then with 18 in both settings converts to 123,423.400,000,000,000,000,000
